...
void ecrire_debut(char* file){
    ...
    int8_t tab[22] = { 0xff, 0xd8,0xff,0xd9,0xff, 0xe0, 0x00, 0x10, 0x4a, 0x46, 0x49, 0x46, 0x00,0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; 
    for (int i = 0; i < 22;i++){
